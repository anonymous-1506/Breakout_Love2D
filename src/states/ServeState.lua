...
function ServeState:enter(params)
    ...
    --new table that will store all the balls
    self.balls = {}

    -- init new ball (random color for fun) -- the first ball inserted in the table
...
function ServeState:update(dt)
    ...
    for i, pairs in pairs(self.balls) do
        pairs.x = self.paddle.x + (self.paddle.width / 2) - 4
